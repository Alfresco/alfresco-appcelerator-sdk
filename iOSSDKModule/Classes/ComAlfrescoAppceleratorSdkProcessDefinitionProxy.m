...
//
//  ComAlfrescoAppceleratorSdkProcessDefinitionProxy.m
//  iOSSDKModule
//
...
@interface ComAlfrescoAppceleratorSdkProcessDefinitionProxy()
@property(nonatomic,strong) AlfrescoWorkflowProcessDefinition *processDefinition;
@end

@implementation ComAlfrescoAppceleratorSdkProcessDefinitionProxy

-(id)initWithProcessDefinition:(AlfrescoWorkflowProcessDefinition *)processDefinition
{
    self = [super init];
