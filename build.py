...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','com.alfresco.appcelerator.module.ios.sdk.js')
...
""" % module_assets
	...
	assets_router = os.path.join(cwd,'Classes','ComAlfrescoAppceleratorModuleIosSdkModuleAssets.m')
